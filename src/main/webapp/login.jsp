...
<div class="container">
    ...
    <div class="tab-content">
        ...
        <div id="signup" class="tab-pane">
            <form action="${pageContext.request.contextPath}/user/register"  class="form-signin">
                <p class="text-muted text-center btn-block btn btn-primary btn-rect">Please Fill Details To Register</p>
                <input type="text" name="userAcount" placeholder="userAcount" class="form-control" />
                ...
                <input type="password" name="userPwd" placeholder="Re type password" class="form-control" />
