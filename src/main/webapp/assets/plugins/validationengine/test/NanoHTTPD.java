 ...
 *    <li> File server supports directory listing, main.jsp and index.htm </li>
 ...
 new File("").getAbsolutePath() + "\"" );
							   ...
							   boolean allowDirectoryListing )
	{
		...
		if ( f.isDirectory())
		{
			...
			// First try main.jsp and index.htm
			if ( new File( f, "main.jsp" ).exists())
				f = new File( homeDir, uri + "/main.jsp" );
